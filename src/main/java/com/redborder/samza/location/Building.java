...
public class Building extends Location {
    public Building(Long consolidatedTime, Long expiredTime, Long tGlobal, Long tLastSeen, Long tTransition,
    ...
    public Building(Long consolidatedTime, Long expiredTime, Map<String, Object> rawLocation, String uuidPrefix) {
